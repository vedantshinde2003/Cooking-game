...
namespace Lean.Touch
{
	...
	public class LeanDragTranslate : MonoBehaviour
	{
       /// <summary>
        ...
        /// <summary>
        /// The camera the translation will be calculated using. None/null = MainCamera.
        /// </summary>
        ...
        /// <summary>
        /// The movement speed will be multiplied by this. -1 = Inverted Controls.
        /// </summary>
        public float Sensitivity { set { sensitivity = value; } get { return sensitivity; } }

        [SerializeField]
        private float sensitivity = 1.0f;
        private Vector3 axesMultipler = Vector3.one;
			...
			private void TranslateUI(Vector2 screenDelta)
        {
            ...
            { 
                if (!moveX) worldPoint.x = transform.position.x * axesMultipler.x;
                if (!moveY) worldPoint.y = transform.position.y * axesMultipler.y;
                if (!moveZ) worldPoint.z = transform.position.z * axesMultipler.z;
        ...
        public void setDrag(Vector3 forces, float s ,bool x, bool y, bool z)
        {
            axesMultipler = forces;

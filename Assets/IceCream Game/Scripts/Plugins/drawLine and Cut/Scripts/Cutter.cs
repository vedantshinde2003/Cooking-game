...
public class Cutter : MonoBehaviour
{
    ...
    public static void Cut(GameObject originalGameObject, Vector3 contactPoint, Vector3 cutNormal, Material m)
    {
        ...
        Material[] materials =  originalGameObject.GetComponent<MeshRenderer>().materials;
        ...
        originalGameObject.GetComponent<MeshRenderer>().materials = materials;


     
        right.GetComponent<MeshRenderer>().materials = materials;
        
        var rightRigidbody = right.AddComponent<Rigidbody>();
        rightRigidbody.AddRelativeForce(-cutPlane.normal * 1);
